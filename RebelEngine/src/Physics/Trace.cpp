...
namespace
{
	...
	void DrawWireCapsule(const Vector3& center, float halfHeight, float radius, const Vector3& color)
	{
		...
		DrawWireSphere(top - Vector3{0,0,radius}, radius, color);
		DrawWireSphere(bottom + Vector3{0,0,radius}, radius, color);
	}
}
...
bool LineTraceSingle(
	...
	EDrawDebugTrace::Type drawDebugType)
{
	const bool bHit = world.LineTraceSingle(start, end, outHit, params);
	...
	EDrawDebugTrace::Type drawDebugType)
{
	...
	return LineTraceSingle(*world, start, end, outHit, params, drawDebugType);
}
...
bool LineTraceMulti(
	...
	EDrawDebugTrace::Type drawDebugType)
{
	const bool bHit = world.LineTraceMulti(start, end, outHits, params);
	if (ShouldDrawDebug(drawDebugType))
	{
	...
	EDrawDebugTrace::Type drawDebugType)
{
	...
	return LineTraceMulti(*world, start, end, outHits, params, drawDebugType);
}
...
bool SphereTraceSingle(
	...
	EDrawDebugTrace::Type drawDebugType)
{
	const bool bHit = world.SphereTraceSingle(start, end, radius, outHit, params);
	if (ShouldDrawDebug(drawDebugType))
	...
	EDrawDebugTrace::Type drawDebugType)
{
	...
	return SphereTraceSingle(*world, start, end, radius, outHit, params, drawDebugType);
}
...
bool CapsuleTraceSingle(
	...
	EDrawDebugTrace::Type drawDebugType)
{
	const bool bHit = world.CapsuleTraceSingle(start, end, halfHeight, radius, outHit, params);
	if (ShouldDrawDebug(drawDebugType))
	...
	EDrawDebugTrace::Type drawDebugType)
{
	...
	return CapsuleTraceSingle(*world, start, end, halfHeight, radius, outHit, params, drawDebugType);
}
...
bool BoxTraceSingle(
	...
	EDrawDebugTrace::Type drawDebugType)
{
	const bool bHit = world.BoxTraceSingle(start, end, halfExtents, rotation, outHit, params);
	if (ShouldDrawDebug(drawDebugType))
		DrawDebugLineTrace(start, end, bHit ? &outHit : nullptr);
	return bHit;
}
	...
	EDrawDebugTrace::Type drawDebugType)
{
	...
	return BoxTraceSingle(*world, start, end, halfExtents, rotation, outHit, params, drawDebugType);
}
...
{
	DrawWireCapsule(start, halfHeight, radius, {1,0,0});
	DrawWireCapsule(end, halfHeight, radius, {0,1,0});
	PhysicsDebug::DrawLine(start, end, kTraceColor);
